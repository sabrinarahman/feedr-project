...
(0, _jquery2.default)(document).ready(function () {
  ...
  var SOURCES = [{
    ...
    formatResponse: function formatResponse(response) {
      return _lodash2.default.map(response.data.children, function (child) {
        return {
    ...
    formatResponse: function formatResponse(response) {
      ...
      return _lodash2.default.map(articles, function (article) {
        return {
  ...
  var Utils = {
    getArticlesMarkup: function getArticlesMarkup(articles) {
      return _lodash2.default.map(articles, function (article) {
        return Utils.getSingleArticleMarkup(article);
      });
    },
    getSingleArticleMarkup: function getSingleArticleMarkup(article) {
  ...
  var App = {
    ...
    bindEvents: function bindEvents() {
      ...
      (0, _jquery2.default)('#main').on('click', '.article', function (e) {
      ...
      (0, _jquery2.default)('.closePopUp').on('click', function () {
        App.setView("feed");
      });
      ...
      (0, _jquery2.default)('.sources-dropdown li').on('click', function () {
        var index = (0, _jquery2.default)(this).index();
        App.showFeed(SOURCES[index]);
      });
    },
    showDefaultFeed: function showDefaultFeed() {
      var defaultFeed = _lodash2.default.find(SOURCES, { defaultSource: true });
      App.showFeed(defaultFeed);
    },
    showFeed: function showFeed(feed) {
      var request = App.requestFeed(feed.url, feed.proxyRequired);
      request.done(function (response) {
        var articles = feed.formatResponse(response);
        App.articles = articles;
        App.renderFeed(articles);
        App.setView("feed");
      });
    },
    requestFeed: function requestFeed(url, proxyRequired) {
      var feedUrl = proxyRequired ? PROXY_URL + url : url;
      App.setView("loader");
      return _jquery2.default.ajax(feedUrl, {
        dataType: "json"
      });
    },
    renderFeed: function renderFeed(articles) {
      var articlesMarkup = Utils.getArticlesMarkup(articles);
      (0, _jquery2.default)("#main").html(articlesMarkup);
    },
    ...
    changePopupData: function changePopupData(article) {
      console.log(article);
      (0, _jquery2.default)('#popUp h1').html(article.title);
      (0, _jquery2.default)('#popUp p').html(article.description);
      (0, _jquery2.default)('.popUpAction').attr('href', article.link);
    }
  };
  App.init();
});
